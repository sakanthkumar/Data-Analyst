...
# Directly create the directory structure
...
# Create llm_service.py - exact content needed
...
with open(os.path.join(services_path, 'llm_service.py'), 'w') as f:
    f.write(llm_service_content)

print("✓ Services directory created")
print("✓ __init__.py created")
print("✓ llm_service.py created")
print(f"\nServices path: {services_path}")
print(f"Files: {os.listdir(services_path)}")
